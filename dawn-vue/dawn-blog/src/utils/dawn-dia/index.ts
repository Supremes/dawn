...
export class DawnDia {
  configs: DiaConfig = {
    locale: 'en',
    tips: {}
  }
  software = new DawnBotSoftware()
  ...
  installSoftware(configs: DiaConfig): void {
    ...
    this.software = new DawnBotSoftware({
      locale: this.configs.locale,
      botScript: this.configs.tips,
      containerId: 'Dawn-Dia--tips-wrapper',
      messageId: 'Dawn-Dia--tips'
    })
  }
  on(): void {
    this.software.load()
  ...
  activateMotion(): void {
    const leftEye = document.getElementById('Dawn-Dia--left-eye')
    const rightEye = document.getElementById('Dawn-Dia--right-eye')
    const eyesEl = document.getElementById('Dawn-Dia--eyes')
